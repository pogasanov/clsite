...
urlpatterns = [
    ...
    path(
        "profile/complete",
        view_register.profile_signup_flow_complteted_view,
    ...
    path(
        "profiles/jurisdictions/<jurisdiction_value>/law-type-tags/<law_tags_value>",
        views.BrowsingView.as_view(),
        name="profiles-browsing",
    ),
